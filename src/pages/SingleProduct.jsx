...
import { getFallbackProductById } from "../utils/fallbackData"
...
const SingleProduct = () => {
  ...
  // Ensure we have product data, fallback if needed
  const productData = product || getFallbackProductById(id)
  ...
  return (
    <>
      ...
      <div className="container mx-auto my-10 grid gap-16 px-5 md:grid-cols-2 xl:my-32 xl:px-28  ">
        {/* Left */}
        <ProductImages product={productData} images={images} />
        ...
        <div className="">
          <section className=" flex flex-col justify-between  space-y-6  ">
            ...
            {stock >= 1 && <AddToCart product={productData} />}
            <div className=" pt-8 ">
              <hr />
            </div>
          </section>
