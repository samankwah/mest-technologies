...
const Completion = () => {
  ...
  useEffect(() => {
    const transactionId = paymentIntent || paymentData?.paymentReference
    ...
    if (transactionId) {
      ...
      window.dataLayer.push({
        ...
        ecommerce: {
          ...
          currency: "GHS", // Updated to Ghana Cedis
          value: total_amount,
      ...
      <article className=" rounded bg-gray-100 py-10 px-5 text-center md:p-16">
        <div className=" flex flex-col items-center justify-center space-y-4 ">
          ...
          <div className=" text-center ">
            ...
            <p className=" text-sm ">
              Your order ID: {paymentData?.paymentReference || paymentIntent || "N/A"}
            </p>
            {paymentData?.amount && (
